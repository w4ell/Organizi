      ...
      */}
      <div className="p-5 sm:p-8">
        <div className="columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-1">
          <div className="before:rounded-2xl relative before:absolute before:left-0 before:right-0 before:top-0 before:z-10 before:h-full before:w-full before:bg-[#000000] before:opacity-50">
            <img
            ...
            <div className="absolute inset-0 h-full w-full flex flex-col justify-center items-center text-[#EE317F] font-bold z-10 rounded">
              <button
                className=" h-[50px] p-2 border-[2px] border-[#EE317F] hover:bg-[#EE317F] flex justify-center items-center text-white font-semibold rounded"
